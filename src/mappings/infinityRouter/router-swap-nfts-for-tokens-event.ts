...
const HANDLER_KEY = 'infinityRouterSwapNftsForTokensEvent'
const EVENT_KEY = 'wasm-router-swap-nfts-for-tokens'
...
export const infinityRouterSwapNftsForTokensEvent = eventHandler(
  HANDLER_KEY,
  EVENT_KEY,
  handlerFn,
)
